...
public class MeatHarvesterWave {
    private MeatHarvester enemyType;
    private int enemyPerWave;
    private StackPane pane;
    private Path path;

    private ArrayList<MeatHarvester> enemies;

    public MeatHarvesterWave(MeatHarvester enemyType, int enemyPerWave, StackPane pane, Path path) {
